...
![GitHub Pages](https://img.shields.io/badge/GitHub%20Pages-배포중-00ff41?style=flat&logo=github&labelColor=050d05)
![Vanilla JS](https://img.shields.io/badge/Vanilla%20JS-서버없음-ffb000?style=flat&labelColor=050d05)
![License](https://img.shields.io/badge/License-MIT-blue?style=flat&labelColor=050d05)
...
- **MY STATS** — 게임 기록, 분야별 정답률, 최근 10게임 바 차트
- **826권 도서 데이터** — 실제 인기 대출 도서 기반, 표지 이미지 포함
...
| 데이터 | 정보나루 Open API (공공 도서관 대출 데이터) |
...
정보나루 API
    ↓
fetch_books.py       # KDC 분야별 인기 도서 수집 (826권)
    ↓
...
```bash
# 정보나루 API 키 필요 (https://www.data4library.kr/)
...
*도서 데이터 출처: [정보나루 (data4library.kr)](https://www.data4library.kr/)*
